...
enum DS {
    ...
    enum Colors {
        ...
        static let accent = Color(hex: "#0F9F8A")

        /// Accent hover — slightly darker teal for hover state.
        static let accentHover = Color(hex: "#0B7F70")

        /// Accent text — bright mint used for accent-colored text and icons
        /// on dark backgrounds (links, active nav items, highlighted labels).
        static let accentText = Color(hex: "#4DE6C8")
...
// MARK: - Pip Composer Visual Style

enum PipComposerVisualStyle {
