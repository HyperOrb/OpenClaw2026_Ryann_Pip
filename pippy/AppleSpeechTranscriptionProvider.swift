...
final class AppleSpeechTranscriptionProvider: PipTranscriptionProvider {
...
private final class AppleSpeechTranscriptionSession: NSObject, PipStreamingTranscriptionSession {
